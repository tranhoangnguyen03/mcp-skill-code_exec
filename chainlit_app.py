...
from agent_workspace.hr_agent.openrouter_client import OpenRouterClient
from agent_workspace.hr_agent.types import ExecutionResult


def _load_env():
    repo_root = Path(__file__).resolve().parent
    env_path = repo_root / "agent_workspace" / ".env"
    if env_path.exists():
...
async def on_chat_start():
    ...
    model_name = os.getenv("open_router_model_name")
