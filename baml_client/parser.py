...
class LlmResponseParser:
    ...
    def WorkflowCodegen(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="WorkflowCodegen", llm_response=llm_response, mode="request")
        return typing.cast(str, __result__)
...
class LlmStreamParser:
    ...
    def WorkflowCodegen(
        ...
        __result__ = self.__options.merge_options(baml_options).parse_response(function_name="WorkflowCodegen", llm_response=llm_response, mode="stream")
        return typing.cast(str, __result__)
